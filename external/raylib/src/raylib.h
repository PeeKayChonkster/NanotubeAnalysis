...
RLAPI Vector2 MeasureTextDefaultFont(const char* text, int fontSize);                       // Measure string size for default font
...
RLAPI float TextToFloat(const char *text);                            // PRIM: Get float value from text
